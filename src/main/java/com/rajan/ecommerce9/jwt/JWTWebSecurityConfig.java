...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity webSecurity) throws Exception {
		webSecurity.ignoring().antMatchers(HttpMethod.POST, authenticationPath)
				...
				.antMatchers("/allProduct/{key}/**/**")
				.and().ignoring()
				.antMatchers("/uploadImage1/**/**")
				.and().ignoring()
				.antMatchers("/uploadImage2/**/**")
				.and().ignoring()
				.antMatchers("/uploadImage3/**/**")
				.and().ignoring()
				.antMatchers("/upload/**/**")
				.and().ignoring()
				.antMatchers("/getProductById/{id}/**/**")
				.and().ignoring()
				.antMatchers("/getProductByCategory/{category}/**/**")
				.and().ignoring()
				.antMatchers("/setData/**/**")
				.and().ignoring()
				.antMatchers("/home_page_detail/**/**");
	}
}